...
to setup
  ...
  create-cats cat-count [
    ...
    set size 1
    set color blue
    set energy cat-initial-energy
    setxy random-xcor random-ycor
  ]

  ; Randomly places mice on the environment
  create-mice mouse-count [
    set color green
    set shape "mouse side"
    set energy mouse-initial-energy
    setxy random-xcor random-ycor
  ]
...
; Randomly sets a fixed number of patches as cheese for prey
...
; Eating cheese increase the energy of the mice by 20
...
; Asks the cat agents to check if there is any mice in its current patch
; If so, picks one of the mice randomly and eats it
...
; Moves all agents in the environment by one step in a random direction and subtracts 1 energy
